...
:::image type="content" source="media/virtual-network-appliance-overview/vna-diagram.png" alt-text="Screenshot of a diagram showing Virtual Network Appliance architecture in Azure.":::
...
Many hub and spoke designs rely on a centralized forwarder that can become a bottleneck. Virtual Network Appliance is a lightweight, high-performance forwarding layer that reduces the risk of the forwarding layer becoming the choke point for traffic flows.

### Purpose-built for horizontal scaling and accelerated east–west flows

Virtual Network Appliance is purpose-built for horizontal scaling, accelerated east–west flows, high throughput, and low latency to meet massive bandwidth demands.

### Azure-native management model

Because Virtual Network Appliance is a top-level Azure resource, you can manage and govern it like other Azure networking resources.
