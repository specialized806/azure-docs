...
| **[SystemServiceAzureSpringAppsResourceProvider](/spring-apps/basic-standard/how-to-custom-domain?tabs=Azure-portal#key-vault-private-link-considerations)** | Azure Spring Apps.<br/><br/>This tag represents the IP addresses used for Azure Spring Apps Resource Provider outbound traffics. | Inbound | Yes | Yes |
