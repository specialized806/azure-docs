...
|[Managed disk encryption](/azure/virtual-machines/disk-encryption-overview)|Server-side encryption for managed disks using platform-managed or customer-managed keys. Encryption at host provides end-to-end encryption including temp disks and caches.|
