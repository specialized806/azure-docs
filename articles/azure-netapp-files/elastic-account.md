...
The Elastic zone-redundant service level is currently in preview. You must register for the `ANFElasticZRS` AFEC before using zone-redundant storage for the first time. 
