...
1. Choose the **Volume** menu then the volume you want to restore.
1. Go to the **Snapshots** menu. Right-click the snapshot you want to use for the revert operation. Select **Revert volume**. 
