...
>[!IMPORTANT]
>To create an SMB volume for the Elastic zone-redundant service level, see [Create an SMB volume for the Elastic zone-redundant service level](elastic-volume-server-message-block.md).
