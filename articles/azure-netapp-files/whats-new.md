...
* [Application volume group for Oracle](configure-application-volume-oracle-api.md#replication) supports cross-zone and cross-region replication is now generally available (GA)
