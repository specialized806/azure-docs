...
|----------|-------------|------------|
| **Chatbots and RAG applications** | Build intelligent web apps using Azure OpenAI for chat or retrieval augmented generation (RAG) | [Get started](#chatbots-and-rag-applications) |
| **Agentic web applications** | Transform traditional CRUD apps with conversational AI agents using Semantic Kernel, LangGraph, or Foundry Agent Service | [Get started](#build-agentic-web-applications) |
| **OpenAPI tools for Foundry agents** | Expose your web app's REST APIs as tools that Foundry Agent Service can call | [Get started](#app-service-as-openapi-tool-in-microsoft-foundry-agent) |
| **Model Context Protocol servers** | Extend GitHub Copilot Chat, Cursor, and Winsurf with your app's capabilities through MCP | [Get started](#app-service-as-model-context-protocol-mcp-servers) |
| **Local small language models** | Deploy SLMs as sidecar containers for complete data privacy and no external dependencies | [Get started](#use-a-local-slm-sidecar-container) |
| **Secure AI applications** | Protect your AI tools and MCP servers with Microsoft Entra authentication | [Get started](#authenticate-tool-calls-to-app-service) |
