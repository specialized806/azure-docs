...
Note that one time purchase amount for Azure Prepayment (previously called monetary commitment) is not shown in Cost Analysis, these can be tracked through [credits & commitments view in EA](reporting-get-started#invoices-and-credits) and [credit balances view in Microsoft Customer Agreement.](../benefits/credits/mca-check-azure-credits-balance.md). 
