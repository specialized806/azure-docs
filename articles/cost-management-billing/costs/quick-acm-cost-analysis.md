...
Note that one time purchase for Azure Prepayment (previously called monetary commitment) is not shown in Cost Analysis, these can be tracked through credits & commitments view in EA and [credit balances view for billing profile for Microsoft Customer Agreement](../benefits/credits/mca-check-azure-credits-balance.md). 
...
> [!NOTE]
> - If you want to monitor your forecasted cost, you can enable the Forecast KPI preview feature in Cost Management Labs, available from the **Try preview** command.
