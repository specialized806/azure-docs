...
| SKU | [Bastion Premium SKU](bastion-sku-comparison.md#bastion-premium-sku)| Bastion Premium SKU is now generally available in all regions that Bastion is available in. | Generally available | June 2024 | N/A|
| Feature | [Microsoft Entra ID support for portal (SSH)](bastion-connect-vm-ssh-linux.md#microsoft-entra-id-authentication)  |Microsoft Entra ID support for SSH connections in portal is now GA. To learn more about Microsoft Entra ID with Azure Bastion, see [Configure Microsoft Entra ID authentication with Azure Bastion](bastion-entra-id-authentication.md). | Generally available | November 2024 | N/A|
