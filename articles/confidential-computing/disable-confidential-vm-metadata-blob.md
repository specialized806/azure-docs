...
To list, register, or unregister preview features in your Azure subscription, you need access to the `Microsoft.Features/*` actions. This permission is granted through the [Contributor](./role-based-access-control.md/built-in-roles.md#contributor) and [Owner](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#owner) built-in roles. You can also specify the required access through a [custom role](https://learn.microsoft.com/azure/role-based-access-control/custom-roles).
