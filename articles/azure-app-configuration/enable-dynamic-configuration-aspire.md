...
In this tutorial, you enabled your Aspire app to dynamically refresh configuration settings from App Configuration. To learn how to add a feature flag to an Aspire application, continue to the next tutorial:
