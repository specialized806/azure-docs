...
## Metrics
Metrics are collected automatically for your App Configuration store and are available immediately—no additional settings required.
...
For more information, refer to [Monitoring App Configuration data reference](./monitor-app-configuration-reference.md#azuremonitorlogstables).
...
For more information, refer to [Monitoring App Configuration data reference](./monitor-app-configuration-reference.md#resourcelogs).
...
#### Http request Log
In the portal, navigate to **Logs** under **Monitoring** section, and then go to the query editor. Expand **Tables** and select **AACHttpRequest** to see the HTTP request logs of your configuration store. Enter a Kusto query into the editor and results will be displayed below.
...
#### Audit Log
In the portal, navigate to **Logs** under **Monitoring** section, and then go to the query editor. Expand **Tables** and select **AACAudit** to see the audit logs of your configuration store. Enter a Kusto query into the editor and results will be displayed below.
