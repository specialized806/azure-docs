...
- **SCSI shared controller:** When using SCSI bus sharing, use with bus type as "Physical" for VMs. VMs connected to Virtual SCSI controllers will be powered-off. For more information, see [Broadcom KB article](https://knowledge.broadcom.com/external/article?legacyId=2147661).
