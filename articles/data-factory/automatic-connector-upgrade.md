...
| [Jira](connector-jira.md) | Scenario that doesn't rely on below capability in Jira (version 1.0):<br><br>• Authentication types:<br>&nbsp;&nbsp;• OAuth 1.0<br>• Use useEncryptedEndpoints, useHostVerification and usePeerVerification as connection properties.<br>• Use query.<br><br>If your pipeline runs on self-hosted integration runtime, it requires SHIR version 5.61 or above. |
...
| [Xero](connector-xero.md) | Scenario that doesn't rely on below capability in Xero (version 1.0):<br><br>• Authentication types:<br>&nbsp;&nbsp;• OAuth 1.0<br>• Use useEncryptedEndpoints, useHostVerification and usePeerVerification as connection properties.<br>• Use query.<br><br>If your pipeline runs on self-hosted integration runtime, it requires SHIR version 5.61 or above. |
