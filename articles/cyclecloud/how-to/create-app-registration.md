...
If you've deployed Azure CycleCloud Workspace for Slurm, use the provided helper utility [script](./ccws/plan-your-deployment.md#post-deployment-utility) to automatically execute the instructions.
