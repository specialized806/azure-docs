...
| [Microsoft Entra workload identity authentication](self-hosted-gateway-enable-workload-identity.md)   | No secrets or certificates to manage - uses federated identity credentials.<br/><br/>Automatic token rotation with short-lived tokens.<br/><br/>Native integration with Azure Kubernetes Service (AKS).<br/><br/>Enhanced security posture by eliminating secret management.        |
