...
1. On the **Register an MCP server with Azure Logic Apps** wizard home page, follow these steps:
   ...
   1. In the **Tools** section, under **Connectors**, select **Add**.

      :::image type="content" source="media/create-mcp-server-api-center/add-connector.png" alt-text="Screenshot shows Connections section with selected options for Add." lightbox="media/create-mcp-server-api-center/add-connector.png":::
