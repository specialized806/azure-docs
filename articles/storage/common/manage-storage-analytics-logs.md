...
> [!NOTE]
> The logging version for Azure Storage Analytics (classic) is set automatically by Azure and isn’t configurable. In the Azure portal, the default value may appear as **Logging Version = 2.0.**
