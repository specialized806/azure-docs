...
- This article assumes you've already installed Azure Container Storage v2.x.x on your AKS cluster, and that you've created a persistent volume claim (PVC) using either [Elastic SAN](use-container-storage-with-elastic-san.md) or [ephemeral disk (local NVMe)](use-container-storage-with-local-disk.md). 
