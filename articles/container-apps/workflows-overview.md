...
> [!NOTE]
> Currently, the Durable Task Python and Java SDKs are in preview. To learn which framework is recommended for production use, see [Choosing an orchestration framework](../azure-functions/durable/choose-orchestration-framework.md).
...
Applications built using either the Durable Task SDKs or Durable Functions can be hosted in Azure Container Apps. To learn which framework works best for your scenario, see [Choosing an orchestration framework](../azure-functions/durable/choose-orchestration-framework.md). 
