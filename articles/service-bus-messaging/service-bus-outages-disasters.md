...
> [!NOTE]
> The availability zones support is only available in [Azure regions](/azure/reliability/availability-zones-region-support) where availability zones are present.
