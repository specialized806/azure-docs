...
- Generate key frames for OPC UA data points to enable downstream services to recover state more quickly. For more information, see [Understand key frames for OPC UA data points](#understand-key-frames-for-opc-ua-data-points).
