...
> [!NOTE]
> This sample uses library code generated by v1 protocol compiler from a [DTDL model](https://github.com/Azure/iot-operations-sdks/blob/johndo/sample-TestThing-Counter/eng/test/schema-samples/counter.json). For a sample using the v2 protocol compiler with WoT Thing model files, see the [TestThing](https://github.com/Azure/iot-operations-sdks/tree/johndo/sample-TestThing-Counter/dotnet/samples/Protocol/TestThing) folder.
