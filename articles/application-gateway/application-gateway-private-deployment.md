...
>[!Tip]
>[Learn more about Application Gateway DNS resolution](./application-gateway-dns-resolution.yml#gateways-with-private-ip-address-only-networkisolationenabled-true)
