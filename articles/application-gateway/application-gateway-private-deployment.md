...
>[!Tip]
>[Learn more about Application Gateway DNS resolution](./application-gateway-dns-resolution#gateways-with-private-ip-address-only-networkisolationenabled-true)
