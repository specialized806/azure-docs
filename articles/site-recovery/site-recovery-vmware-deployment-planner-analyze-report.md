...
This article discusses the sheets contained in the Excel report generated by Azure Site Recovery Deployment Planner for a VMware to Azure scenario.

To generate a report, see [Run the Deployment Planner and generate a report for VMware disaster recovery](site-recovery-vmware-deployment-planner-run.md).

## On-premises summary

The On-premises summary worksheet provides an overview of the profiled VMware environment.

:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/on-premises-summary-v2a.png" alt-text="Screenshot of On-premises summary of VMware environment.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/recommendations-v2a.png" alt-text="Screenshot of Recommendations for VMware to Azure report.":::

### Profiled data

:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/profiled-data-v2a.png" alt-text="Screenshot of the profiled-data view in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/profiling-overview-v2a.png" alt-text="Screenshot of Profiling results in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/required-network-bandwidth-v2a.png" alt-text="Screenshot of required network bandwidth in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/required-cores-v2a.png" alt-text="Screenshot of required number of Azure cores in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/required-on-premises-components-v2a.png" alt-text="Screenshot of required on-premises infrastructure in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/what-if-analysis-v2a.png" alt-text="Screenshot of what-if analysis in the deployment planner.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/ir-batching-v2a.png" alt-text="Screenshot of recommended virtual machine batch size.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/growth-factor-v2a.png" alt-text="Screenshot of growth factor and percentile values used.":::

## Recommendations with available bandwidth as input

:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/profiling-overview-bandwidth-input-v2a.png" alt-text="Screenshot of recommendations with available bandwidth as input.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/achievable-rpo-v2a.png" alt-text="Screenshot of achievable RPO for 500 Mbps bandwidth.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/vm-storage-placement-v2a.png" alt-text="Screenshot of virtual machine-storage placement.":::
...
:::image type="content" source="media/site-recovery-vmware-deployment-planner-analyze-report/compatible-vms-v2a.png" alt-text="Screenshot of excel spreadsheet of compatible virtual machines.":::
