...
To generate a report, see [Run the Azure Site Recovery deployment planner to generate a report for Hyper-V VMs](hyper-v-deployment-planner-run.md).

## On-premises summary

The on-premises summary worksheet provides an overview of the profiled Hyper-V environment.

:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/on-premises-summary-h2a.png" alt-text="Screenshot of On-premises summary.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/recommendations-h2a.png" alt-text="Screenshot of recommendations for Hyper-V to Azure report.":::

### Profile data

:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/profile-data-h2a.png" alt-text="Screenshot of profile data.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/profiling-overview-h2a.png" alt-text="Screenshot of profiling overview.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/required-network-bandwidth-h2a.png" alt-text="Screenshot of required network bandwidth.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/required-storage-accounts-h2a.png" alt-text="Screenshot of required Azure storage accounts.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/required-number-of-azure-cores-h2a.png" alt-text="Screenshot of required number of Azure cores.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/on-premises-storage-copy-frequency-h2a.png" alt-text="Screenshot of On-premises storage requirement and copy frequency.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/what-if-analysis-h2a.png" alt-text="Screenshot of What-if-analysis.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/ir-batching-h2a.png" alt-text="Screenshot of IR batching.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/cost-estimation-summary-h2a.png" alt-text="Screenshot of Cost estimation summary.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-run/growth-factor-max-percentile-value.png" alt-text="Screenshot of Growth factor and percentile values used.":::

## Recommendations with available bandwidth as input

:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/profiling-overview-bandwidth-input-h2a.png" alt-text="Screenshot of Profiling overview with bandwidth input.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/vm-storage-placement-h2a.png" alt-text="Screenshot of VM-storage placement.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/compatible-vms-h2a.png" alt-text="Screenshot of Compatible VMs.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/incompatible-vms-h2a.png" alt-text="Screenshot of Incompatible VMs.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/on-premises-storage-requirement-h2a.png" alt-text="Screenshot of On-premises storage requirement.":::
...
:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo-h2a.png" alt-text="Screenshot of IR batching details.":::

:::image type="content" source="media/hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo2-h2a.png" alt-text="Screenshot of Additional IR batching details.":::
