...
You can view the cost either monthly or yearly. Learn more about [supported target regions](#supported-target-regions) and [supported currencies](#supported-currencies).
