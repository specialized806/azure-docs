---
title: Run the Azure Site Recovery deployment planner to generate a report for Hyper-V VMs
...
# Run the Azure Site Recovery deployment planner to generate a report for Hyper-V VMs
