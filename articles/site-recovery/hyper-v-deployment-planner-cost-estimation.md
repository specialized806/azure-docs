...
[Generate](hyper-v-deployment-planner-run.md) and [analyse](hyper-v-deployment-planner-analyze-report.md) the report before you review the cost estimation summary.
