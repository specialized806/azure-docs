---
title: Choose whether to use the Durable Task Framework or Durable Task SDKs
description: Learn the differences between the Durable Task Framework (DTFx) and the Durable Task SDKs and when to use them.
author: hhunter-ms
...
# Choose whether to use the Durable Task Framework or Durable Task SDKs
