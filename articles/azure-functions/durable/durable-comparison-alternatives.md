---
title: Choose the right Azure workflow solution for your project
description: Learn how Azure Durable compares to other Azure workflow and messaging solutions.
#customer intent: As an Azure developer looking to orchestrate activities and workflows, I want to know which Azure workflow and messaging solution, including Azure Durable, would work best for my project.
author: hhunter-ms
...
# Choose the right Azure workflow solution for your project
...
- [Orchestration frameworks comparison](durable-task-scheduler/choose-orchestration-framework.md)
- [Throughput benchmark](durable-task-scheduler/durable-task-scheduler-work-item-throughput.md)
- [When to use Azure Durable](durable-use-cases.md)
