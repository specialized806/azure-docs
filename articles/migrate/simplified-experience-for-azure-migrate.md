...
> [!NOTE]
> For the latest list of supported operating systems, including EOL or unsupported OSs such as CentOS, see the Azure support matrix. [Learn more](/azure/site-recovery/vmware-physical-azure-support-matrix).
